About wagtail-json-widget-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/wagtail-json-widget-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/wagtail-json-widget-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add wagtail-json-widget
# for installing globally
pixi global install wagtail-json-widget
```
...
It is possible to list all of the versions of `wagtail-json-widget` available on your platform:
...
```
pixi search wagtail-json-widget --channel conda-forge
```
